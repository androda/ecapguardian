...
int DataBuffer::bufferReadFromSocket(BaseSocket * sock, char *buffer, int size, int sockettimeout)
{
    int pos = 0;
    int rc;
    while (pos < size)    {
...
int DataBuffer::bufferReadFromSocket(BaseSocket * sock, char *buffer, int size, int sockettimeout, int timeout)
{
...
bool DataBuffer::in(BaseSocket * sock, BaseSocket * peersock, HTTPHeader * requestheader, HTTPHeader * docheader, bool runav, int *headersent)
{
