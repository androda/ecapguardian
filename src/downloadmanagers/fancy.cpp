...
public:
	...
	void sendLink(BaseSocket &peersock, String &linkurl, String &prettyurl);
...
void fancydm::sendLink(BaseSocket &peersock, String &linkurl, String &prettyurl)
{
...
int fancydm::in(DataBuffer * d, BaseSocket * sock, BaseSocket * peersock, class HTTPHeader * requestheader, class HTTPHeader * docheader, bool wantall, int *headersent, bool * toobig)
{
